...
class HomeController extends FrontendController
{
    public function index()
    {
        ...
        //Sản phẩm bán chạy
        $productsPay=Product::select('products.id','products.pro_name','products.pro_slug','products.pro_sale','products.pro_avatar','products.pro_price','products.pro_review_total','products.pro_review_star')
        ->join('orders','products.id','=','orders.od_product_id')
        ->groupBy('products.id','products.pro_name','products.pro_slug','products.pro_sale','products.pro_avatar','products.pro_price','products.pro_review_total','products.pro_review_star')
