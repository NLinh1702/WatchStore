    ...
    EVdn: function (t, e, n) {
        ...
        !(function (e, n) {
            ...
            (C.Callbacks = function (t) {
                ...
                C.extend({
                        ...
                        var e = [
                            ...
                            r = {
                                ...
                                then: function (t, i, r) {
                                    ...
                                    return C.Deferred(function (n) {
                                        e[0][3].add(
                                            s(0, n, v(r) ? r : M, n.notifyWith)
                                        ),
                                            e[1][3].add(s(0, n, v(t) ? t : M)),
                                            e[2][3].add(s(0, n, v(i) ? i : q));
                                    }).promise();
                                },
                                promise: function (t) {
                    ...
                    when: function (t) {
                        ...
                        if (
                            e <= 1 &&
                            (I(t, o.done(s(n)).resolve, o.reject, !e),
            ...
            (pt = w
                ...
                (ft = w.createElement("input")).setAttribute("type", "radio"),
            ...
            function Ht(t, e, n, i) {
                ...
                if (
                    ...
                    for (
                        a = (s = C.map(wt(r, "script"), Lt)).length;
                        h < d;
                        h++
                    )
                        (c = r),
                    ...
                    if (
                        ...
                        for (o = 0; (s = f[o++]) && !t.isPropagationStopped(); )
                            (d = s),
                                ...
                                (u =
                                    (Q.get(s, "events") || Object.create(null))[
                                        t.type
                            ...
                            r ||
                                ...
                                (c &&
                                    ...
                                    t.isPropagationStopped() &&
                                        d.addEventListener(g, _e),
                                    i[g](),
                                    t.isPropagationStopped() &&
                                        d.removeEventListener(g, _e),
                    ...
                    ajax: function (t, e) {
                        ...
                        function E(t, e, s, l) {
                            ...
                            c ||
                                ...
                                (T.statusText = (e || _) + ""),
                                h
                                    ? m.resolveWith(f, [d, _, T])
                                    : m.rejectWith(f, [T, _, w]),
                                T.statusCode(y),
                                (y = void 0),
                                u &&
                ...
                a = {
                    ...
                    showDropdownUser: function () {
                        t(".js-show-dropdown").click(function (e) {
                            e.preventDefault(),
                                t(".header-menu-user").slideToggle();
                        });
                    },
                    runToken: function () {
                        t.ajaxSetup({
                    ...
                    maintain: function () {
                        t(".js-maintain", function (t) {
                            return (
                                t.preventDefault(),
                                s.a.warning("Đang phát triển tính năng này"),
                                !1
                            );
                        });
                    },
                ...
                var e = n("KDh+"),
                    ...
                    r =
                        (n("UYrX"),
                        {
                            ...
                            loadProductByCategory: function () {
                                if (
                                    "undefined" !=
                                    typeof routeRenderProductByCategory
                                ) {
                                    var n = !1;
                                    t(document).on("scroll", function () {
                                        t(window).scrollTop() > 300 &&
                                            !1 === n &&
                                            ((n = !0),
                                            t.ajax({
