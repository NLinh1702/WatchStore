                ...
                <div class="card card-primary">
                    <div class="card-body">
                        <div class="form-group ">
                            ...
                            <input type="text" class="form-control" name="a_name" placeholder="Iphone 5s ...."
                                autocomplete="off" value="{{ $article->a_name ?? old('a_name') }}">
                ...
                <div class="card">
                    ...
                    <div class="card-body" style="min-height: 288px">
                        <div class="form-group">
                            ...
                            @else
                                <img src="{{ asset('images/noimg.jpg') }}" alt=""
                                    class="margin-auto-div img-rounded" id="image_render"
                                    style="height: 150px; width:100%;">
                            @endif
                        </div>
