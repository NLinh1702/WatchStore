...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <!-- Site wrapper -->
    <div class="wrapper" >
        <nav class="main-header navbar navbar-expand navbar-dark navbar-info" style="background-color: #4b545c">
            <!-- Left navbar links -->
            <ul class="navbar-nav">
                <li class="nav-item">
                ...
                <li class="nav-item dropdown user-menu">
                    ...
                    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <li class="user-footer">
                            ...
                            <a href="{{ route('get.logout.admin') }}" class="btn btn-default btn-flat float-right">Đăng
                                xuất</a>
                        </li>
                    </ul>
                </li>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4" >
            <!-- Brand Logo -->
            <a href="{{ route('admin.statistical') }}" class="brand-link navbar-info" style="background-color: #4b545c">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ pare_url_file(get_data_user('admins', 'avatar')) }}"
                            ...
                            alt="{{ pare_url_file(get_data_user('admins', 'avatar')) }}">
                    </div>
                    <div class="info">
                        <a href="{{ route('admin.statistical') }}"
                            class="d-block">{{ get_data_user('admins', 'name') }}</a>
                    </div>
                </div>
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                       ...
                       with font-awesome or any other icon font library -->
                        ...
                        @foreach (config('sidebar') as $item)
                            ...
                            <li
                                class="nav-item{{ isset($item['sub']) ? ' treeview' : '' }}{{ in_array(Request::segment(2), $item['list-check']) ? ' active menu-open' : '' }}">
        ...
        <footer class="main-footer">
            <strong>NLStore <a href="#">Lê Nhựt Linh</a>.</strong>
            All rights reserved.
