...
<div class="filter-sidebar">
    ...
    {{-- @if (isset($country) && !empty($country))
        <div class="item">
            <div class="item__title">Nhà cung cấp</div>
            <div class="item__content">
                <ul>
    ...
    @if (isset($attributes))
        @foreach($attributes as $key => $attribute)
            @if (!empty($attribute['attributes']))
                <div class="item">
                    <div class="item__title text-center" style="background-color:#ff5722;">{{ $attribute['t_name'] }}</div>
                    <div class="item__content">
                        <ul>
    ...
    @endif
    <div class="item">
        <div class="item__title text-center" style="background-color:#ff5722;">Đánh giá</div>
