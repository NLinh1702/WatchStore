    ...
    <div class="container" id="before-slide">
        <div class="product-two">
            <div class="top text-center">
                <a href="#" class="main-title" style="font-style: italic; color: green;">SẢN PHẨM NỔI BẬT</a>
            </div>
            <div class="bot">
        ...
        <div class="product-three">
            <div class="top">
                <a href="#" title="" class="main-title" style="font-style: italic; color: green; margin-left:500px">SẢN PHẨM BÁN CHẠY</a>
            </div>
            <div class="bot">
                @if ($event1)
                <div class="left">
        ...
        <div class="product-three">
            <div class="top text-center">
                <a href="#" title="" class="main-title" style="font-style: italic; color: green;">SẢN PHẨM MỚI</a>
            </div>
            <div class="bot">
                <div class="left">
                    <div class="image">
